...
import { isTopApp, SubMicroAppInit, sendDataDown, sendDataUp } from 'micro-app-tools';
...
let router: VueRouter | undefined = undefined;
...
window.mount = () => {
  ...
  /** 渲染节点获取方式 */
  const appRenderNode = window.document.body.querySelector('#__subapp_vue2v');
